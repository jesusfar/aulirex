      ...
      <label className="mb-4 block">
        ...
        <span className="relative block">
          ...
          <input
            ...
            className="h-12 w-full rounded-md border border-white/10 bg-black/70 pl-10 pr-4 text-sm font-semibold text-white outline-none shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition placeholder:text-slate-500 focus:border-emerald-400/70 focus:ring-2 focus:ring-emerald-400/20"
          />
        </span>
      </label>
