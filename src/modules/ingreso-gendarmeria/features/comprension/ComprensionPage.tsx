...
export function ComprensionPage() {
    ...
    return (
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-400">
          Materia Lengua del examen de ingreso. Leé cada texto y respondé las
          ...
          {readingPassages.map((p) => {
            ...
            return (
              <button
                ...
                className="rounded-lg border border-white/10 bg-slate-900/72 p-4 text-left transition hover:border-emerald-400/40"
              >
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <span className="mt-3 inline-block text-xs font-bold uppercase tracking-wide text-emerald-300">
